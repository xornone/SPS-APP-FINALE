...
export const GROUP_INFO: Record<GroupLevel, { label: string; range: string; flat: string; hex: string; emoji: string }> = {
  vert: { label: "Vert", range: "24–26 km/h", flat: "≈29–30 km/h sur le plat", hex: "#1F9D63", emoji: "🟢" },
  rouge: { label: "Rouge", range: "26–28 km/h", flat: "≈33–34 km/h sur le plat", hex: "#DC3D3D", emoji: "🔴" },
  violet: { label: "Violet", range: "28+ km/h", flat: "≈37–38 km/h sur le plat", hex: "#7C3AED", emoji: "🟣" },
};
